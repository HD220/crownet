...
**Branch Git Proposta:** test/integration-observe-setup
...
**Notas/Decisões:**
- O arquivo de pesos de fixture pode ser pequeno (e.g., poucos neurônios) para manter os testes rápidos e o arquivo de fixture gerenciável. O importante é que ele seja estável e produza uma saída verificável.
