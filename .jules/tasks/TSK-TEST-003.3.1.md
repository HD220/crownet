...
**Branch Git Proposta:** test/integration-sim-basic
...
**Notas/Decisões:**
- Focar em manter este teste rápido e leve, validando apenas o fluxo de execução.
- A estratégia de execução (binário vs. programático) deve ser consistente com outros testes de integração CLI.
