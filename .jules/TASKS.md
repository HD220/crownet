...
| DOC-003      | Revisão global dos GoDocs                  | Em Andamento | -                  | P2         | AgenteJules | [TSK-DOC-003.md](./tasks/TSK-DOC-003.md)      | Revisados: config, common, neuron (enums, neuron), pulse, neurochemical, space (geometry started). Blocked on examples by tool error. |
