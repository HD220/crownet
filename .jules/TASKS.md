...
| TEST-001     | Aumentar cobertura de testes unitários/integração    | Pendente    | 4 - Alta           | AgenteJules                     | -                  | AAAA-MM-DD      | AAAA-MM-DD                        | Focar em pacotes críticos: network, neuron, pulse, neurochemical, synaptic. |
| FEATURE-002  | Assegurar reprodutibilidade total com seed aleatória | Pendente    | 3 - Média          | AgenteJules                     | -                  | AAAA-MM-DD      | AAAA-MM-DD                        | Verificar uso de rand local vs global e configurar explicitamente se necessário. |
