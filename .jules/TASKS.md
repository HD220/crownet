...
| :----------- | :--------------------------------------------------- | :---------- | :----------------- | :------------------------------ | :----------------- | :-------------- | :-------------------------------- | :-------------------------------------------------------------------- |
| SYS-MIG-001  | Migrar gerenciamento de tarefas para novo formato (índice + arquivos de detalhe) | Pendente    | 4 - Alta           | AgenteJules                     | -                  | 2025-06-24      | AAAA-MM-DD                        | Tarefa estrutural para implementar novo sistema de gerenciamento de tarefas. Prioridade P0. |
