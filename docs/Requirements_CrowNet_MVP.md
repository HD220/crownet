...
*   **RF-CORE-014:** O cortisol deve modular o limiar de disparo dos neurônios (inicialmente diminui, mas com níveis altos, aumenta) e a taxa de sinaptogênese (níveis altos diminuem).
